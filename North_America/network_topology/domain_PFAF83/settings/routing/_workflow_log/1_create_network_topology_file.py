...
last modified :
        11/22/2021
        adding the warning message for centroid to avoid excitment on Graham
        06/13/2022
        deactivate reading the river_outlet_id and check the most downstream ID
        06/20/2022
        1) Round tosegment and segid values from float to int. The values of the 
        tosegments were written in float numbers in the river_shape file. 
        This creates problems in finding segidment ids drains into downstream
"""
#%%# modules
import os
import pandas as pd
...
controlFile = 'control_PFAF83.txt'
#controlFile = 'control_Fraser_modi.txt'
...
#shp_river.loc[shp_river[river_seg_id] == river_down_seg_id] = 0
